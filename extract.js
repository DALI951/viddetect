...
const PKG_EXE = join(BIN_DIR, 'yt-dlp.exe')
const PKG_BIN = join(BIN_DIR, 'yt-dlp')
export const YTDLP_PATH = existsSync(PKG_EXE) ? PKG_EXE : existsSync(PKG_BIN) ? PKG_BIN : 'yt-dlp'
